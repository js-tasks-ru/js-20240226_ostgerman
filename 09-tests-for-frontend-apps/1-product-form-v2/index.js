...
export default class ProductForm {
  ...
  async render() {
    ...
    this.subElements.imageList = new SortableList({
      items: this.product.images.map(
        img => {
          return createElement(this.createImageTemplate(img));
        }) 
    }).element;    
    this.subElements.imageListContainer.append(this.subElements.imageList);
